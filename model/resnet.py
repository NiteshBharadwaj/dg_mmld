...
def resnet50_(num_classes, num_domains=None, pretrained=True):
...
class DGresnet50(nn.Module):
    def __init__(self, num_classes, num_domains, pretrained=True, grl=True):
        super(DGresnet50, self).__init__()
        self.num_domains = num_domains
        self.base_model = resnet50_(num_classes=num_classes, pretrained=pretrained)
        self.discriminator = Discriminator([512, 1024, 1024, num_domains], grl=grl, reverse=True)
